...
model_date = '2025-11-18-18-16-55'
test_dir = '/home/ubuntu/Dataset/99.dataset_train/demo'
model_path = f'/home/ubuntu/networkbuild/pre_train_weights/weights/{model_date}/resnet18_epoch_229_best_loss_0.28_best_acc_95.47.pth'
# 클래스 이름 맵핑
...
def predict(model, test_dir):
    ...
    for scenario in scenarios:
        class_dir = os.path.join(test_dir, scenario)  #class_dir : test/dust, test/haze ...
        ...
        for i, img_name in enumerate(test_images):
            if i % 100 == 0:
                ...
                blockage_prob = probabilities[0][1] + probabilities[0][2] + probabilities[0][3] + probabilities[0][6] + probabilities[0][7] + probabilities[0][8] + probabilities[0][11] + probabilities[0][12] + probabilities[0][13] 
